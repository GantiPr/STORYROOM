...
export default function CharacterEditModal({ isOpen, onClose, onSave, character }: Props) {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setMessages([
        {
          role: "assistant",
          content: `Hi! I'm here to help you edit ${character.name || 'your character'}. I can see their current details and help you refine, expand, or modify any aspect of their character. What would you like to work on?`
        }
      ]);
      setInputValue("");
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 rounded-lg w-full max-w-6xl h-[80vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-zinc-700">
          <h2 className="text-xl font-semibold text-white">Edit {character.name || 'Character'} with AI</h2>
          <button
            onClick={onClose}
          ...
          <div className="flex-1 flex flex-col border-r border-zinc-700">
            ...
            <div className="p-4 border-t border-zinc-700">
              <div className="flex gap-2 mb-2">
                <button
                  onClick={async () => {
                    const extractPrompt = `Based on our conversation, extract all character updates and improvements mentioned and return them as JSON. Include any changes to names, roles, desires, fears, wounds, contradictions, voice details, or character arc information discussed.`;
              ...
              <div className="flex gap-2">
                <textarea
                  ...
                  placeholder="What would you like to change about this character?"
